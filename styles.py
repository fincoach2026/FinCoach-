...
.fc-icon-btn .stButton > button,
.fc-icon-btn button[data-testid="stPopoverButton"] {{
...
.fc-icon-btn .stButton > button p,
.fc-icon-btn button[data-testid="stPopoverButton"] p {{
    color: var(--fc-text) !important;
}}
.fc-icon-btn .stButton > button:hover,
.fc-icon-btn button[data-testid="stPopoverButton"]:hover {{
    transform: scale(1.08);
    background: linear-gradient(90deg, var(--fc-primary), var(--fc-secondary)) !important;
    border-color: transparent !important;
}}
.fc-icon-btn .stButton > button:hover p,
.fc-icon-btn button[data-testid="stPopoverButton"]:hover p {{
    color: #ffffff !important;
}}
...
.fc-auth-page .stTabs [data-baseweb="tab-panel"] {{
    background: {"#000000" if dark_mode else "#FFFFFF"} !important;
    border-radius: 18px;
    padding: 22px;
}}
.fc-auth-page .stTabs [data-baseweb="tab-panel"] p,
.fc-auth-page .stTabs [data-baseweb="tab-panel"] label,
.fc-auth-page .stTabs [data-baseweb="tab-panel"] span,
.fc-auth-page .stTabs [data-baseweb="tab-panel"] div {{
    color: {"#FFFFFF" if dark_mode else "#000000"} !important;
}}
.fc-auth-page .stTextInput input {{
    background: {"#000000" if dark_mode else "#FFFFFF"} !important;
    color: {"#FFFFFF" if dark_mode else "#000000"} !important;
    border: 1.5px solid {"#FFFFFF" if dark_mode else "#000000"} !important;
}}
.fc-auth-page .stButton > button,
.fc-auth-page .stFormSubmitButton > button {{
    background: {"#9FC35C" if dark_mode else "#21815F"} !important;
    color: {"#000000" if dark_mode else "#FFFFFF"} !important;
    box-shadow: none !important;
}}
.fc-auth-page .stButton > button p,
.fc-auth-page .stFormSubmitButton > button p {{
    color: {"#000000" if dark_mode else "#FFFFFF"} !important;
}}
.fc-auth-page .stButton > button:hover,
.fc-auth-page .stFormSubmitButton > button:hover {{

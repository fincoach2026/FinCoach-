...
st.markdown(f"""
<style>
    /* Rounded, friendly app font to match the FinCoach mockups */
    ...
    /* ---- Sidebar: styled like the app's dark green nav ---- */
    ...
    /* ---- Headings: bold black titles, teal green section labels ---- */
    h1 {{
        color: {COLOR_TEXT};
    ...
    /* ---- Buttons: rounded pill style like "Continue" / "Sign Up" ---- */
    .stButton>button, div[data-testid="stFormSubmitButton"]>button {{
        ...
        font-weight: 700;
        box-shadow: 0 2px 6px rgba(33,129,95,0.25);
        transition: background-color 0.15s ease-in-out;
    }}
    ...
    /* ---- Text inputs, number inputs, text areas, selectboxes ---- */
    .stTextInput input, .stNumberInput input, .stTextArea textarea,
    .stSelectbox div[data-baseweb="select"] > div {{
        background-color: {COLOR_WHITE};
        border: 1.5px solid {COLOR_TEAL} !important;
        border-radius: 12px !important;
        color: {COLOR_TEXT};
    }}
    .stTextInput label, .stNumberInput label, .stTextArea label,
    .stSelectbox label, .stSlider label {{
        color: {COLOR_DEEP_GREEN} !important;
        font-weight: 600;
    }}

    /* ---- Radio groups (Yes/No, quiz answers, lesson picker) as pill choices ---- */
    div[role="radiogroup"] {{
        gap: 8px;
    }}
    ...
    /* ---- Metric tiles, like the dashboard cards in the mockups ---- */
    ...
    /* ---- Divider ---- */
    hr {{
        border-top: 1.5px solid {COLOR_TEAL}55;
    }}

    /* ---- Advice / tip cards, outlined like "Watch Out For" boxes ---- */
    .fc-card {{
        background-color: {COLOR_WHITE};
        border: 1.5px solid {COLOR_TEAL};
        border-radius: 14px;
    ...
    /* ---- Solid banner cards, like "Verdict" / "Plan Snapshot" ---- */
    .fc-banner {{
        background-color: {COLOR_DEEP_GREEN};
        color: {COLOR_WHITE} !important;
        padding: 18px 20px;
        border-radius: 14px;
        margin-bottom: 16px;
        box-shadow: 0 2px 8px rgba(33,129,95,0.3);
    }}
    .fc-banner * {{
        color: {COLOR_WHITE} !important;
    }}

    /* ---- Forms (Contact Us) as a soft card, like "Send us a message" ---- */
